...
//
// Filenames are VERSIONED (…-v2) because /models/* ships with a 1-year
...
export const MODEL_URL = '/models/module-v2.glb';
export const MODEL_URL_MOBILE = '/models/module-mobile-v2.glb';
